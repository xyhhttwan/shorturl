 ...
 * $Id:  TextMsgService.java 2016-08-10 21:01:21 $
 */
...
public interface ITextMsgService<D extends IBaseDAO<T>, T extends BaseDomain> extends IBaseService<D, T>,IPageService<D, T> {
