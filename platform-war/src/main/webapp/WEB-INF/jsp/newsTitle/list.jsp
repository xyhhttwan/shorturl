...
<head>
    ...
    <script type="text/javascript">
        ...
        function newItem() {
            ...
            (
                    "新增导航新闻",
                    "<%=basePath%>backstage/news/newsTitleManage/addView.do",
                    0,
                    "<%=basePath%>backstage/news/newsTitleManage/add.do"
        ...
        function editItem() {
            ...
            (
                    "修改导航新闻",
                    "<%=basePath%>backstage/news/newsTitleManage/updateView.do",
                    1,
                    "<%=basePath%>backstage/news/newsTitleManage/update.do"
        ...
        function destroyItem() {
            del("tt", "<%=basePath%>backstage/news/newsTitleManage/delete.do");
        ...
        //上线
        function doPublish() {
            doPost("tt","<%=basePath%>backstage/news/newsTitleManage/setPublishOrUnPublish","","status=1");
        }
        //下线
        function doUnPublish() {
            doPost("tt","<%=basePath%>backstage/news/newsTitleManage/setPublishOrUnPublish","","status=0");
        }
...
<form name="myform" id="myform" method="post">
    ...
    <div id="toolbar">
        ...
        <div style="margin: 5px;backstage: #F4F4F4">
            <shiro:hasPermission name="newsTitle-add">
                <a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="newItem()">新增导航新闻</a>
            </shiro:hasPermission>
            <shiro:hasPermission name="newsTitle-update">
                <a href="#" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="editItem()">修改导航新闻</a>
            </shiro:hasPermission>
            <shiro:hasPermission name="newsTitle-delete">
                <a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true"
                   onclick="destroyItem()">删除导航新闻</a>
            </shiro:hasPermission>
    ...
    <table id="tt" class="easyui-datagrid" height="450px"
           url="<%=basePath%>backstage/news/newsTitleManage/list"
           title="导航新闻列表"
           border="true"
           toolbar="#toolbar"
