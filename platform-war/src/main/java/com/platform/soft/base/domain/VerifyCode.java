...
public class VerifyCode {
    ...
    //前台登录
    public static final String VERIFY_TYPE_COMMENT_FRONT="VERIFY_TYPE_COMMENT_FRONT";

    //前台询价
    public static final String VERIFY_TYPE_COMMENT_FRONT_INQUIRY="VERIFY_TYPE_COMMENT_FRONT_INQUIRY";
