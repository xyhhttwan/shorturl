 ...
 * $Id:  CommonServiceImpl.java 2016-08-10 21:01:20 $
 */
...
import com.platform.soft.service.dao.backstage.ICommonDAO;
...
public class CommonServiceImpl extends AbstractPageService<IBaseDAO<Common>, Common> implements ICommonService<IBaseDAO<Common>,Common> {
    @Autowired
    private ICommonDAO commonDAO;

    @Override
    public IBaseDAO<Common> getDao() {
        return commonDAO;
    }
